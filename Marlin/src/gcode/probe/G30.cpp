...
#if EITHER(DWIN_LCD_PROUI, DWIN_CREALITY_LCD_JYERSUI, DWIN_CREALITY_LCD_ALEXQZDUI)
...
void GcodeSuite::G30() {
  ...
  if (!probe.can_reach(pos)) {
    ...
    #if ANY(DWIN_LCD_PROUI, DWIN_CREALITY_LCD_JYERSUI, DWIN_CREALITY_LCD_ALEXQZDUI)
