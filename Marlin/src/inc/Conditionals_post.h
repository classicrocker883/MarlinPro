 ...
 */
  ...
  #if ANY(HAS_MARLINUI_MENU, EXTENSIBLE_UI, DWIN_LCD_PROUI, DWIN_CREALITY_LCD_JYERSUI, DWIN_CREALITY_LCD_ALEXQZDUI) || BOTH(EMERGENCY_PARSER, HOST_PROMPT_SUPPORT)
 ...
 */
  ...
  #endif
#elif (DISABLED(DWIN_CREALITY_LCD_JYERSUI) && DISABLED(DWIN_CREALITY_LCD_ALEXQZDUI))
  #undef MESH_MIN_X
  #undef MESH_MIN_Y
  #undef MESH_MAX_X
  #undef MESH_MAX_Y
